...
Применительно к верификационному окружению, его компоненты обмениваются транзакциями при помощи вызова методов, реализация которых определяет, какие их них связаны между собой, как это влияет на их внутреннее состояние, а также транзакциями какого типа и на каких условиях они обмениваются.
